            ...
            it "parses the task titles" $ do
                ((^. Task.title) <$>) . (^. Taskell.tasks) <$>
                    ...
                    Right
                        ...
                        , (Task.TaskID 8, "A sub-task with the thing")
                        , (Task.TaskID 9, "Sub Sub Task")
                        , (Task.TaskID 10, "Sub Sub Sub Task")
                        , (Task.TaskID 11, "Süb Task 1")
                        , (Task.TaskID 12, "Süb Task 2")
                        , (Task.TaskID 13, "Another one")
                        , (Task.TaskID 14, "A thing")
                        , (Task.TaskID 15, "Nonsense")
                        , (Task.TaskID 16, "Eat a thing")
                        , (Task.TaskID 17, "This is a task")
                        , (Task.TaskID 18, "Spoons for all!!")
                        , (Task.TaskID 19, "Forks for all!!")
                        , (Task.TaskID 20, "Sporks for no one")
                        ]
            it "parses the task descriptions" $ do
                ((^. Task.description) <$>) . (^. Taskell.tasks) <$>
                    ...
                    Right
                        ...
                        , (Task.TaskID 14, "")
                        , (Task.TaskID 15, "")
                        , (Task.TaskID 16, "This is a thing with some stuff\n\nBlah blah blah")
                        , (Task.TaskID 17, "This is a thing with some stuff\n\nBlah blah blah")
                        , (Task.TaskID 18, "")
                        , (Task.TaskID 19, "Some forks!")
                        , (Task.TaskID 20, "Sporks are too sporky")
                        ]
            it "parses the related tasks" $ do
                ((^. Task.related) <$>) . (^. Taskell.tasks) <$>
                    result `shouldBe`
                    Right
                        [ (Task.TaskID 1, [Task.TaskID 7, Task.TaskID 16])
                        , (Task.TaskID 2, [])
                        , (Task.TaskID 3, [])
                        , (Task.TaskID 4, [])
                        , (Task.TaskID 5, [Task.TaskID 17])
                        , (Task.TaskID 6, [Task.TaskID 16])
                        ...
                        , (Task.TaskID 14, [])
                        , (Task.TaskID 15, [])
                        , (Task.TaskID 16, [Task.TaskID 6, Task.TaskID 1])
                        , (Task.TaskID 17, [Task.TaskID 5])
                        , (Task.TaskID 18, [])
                        , (Task.TaskID 19, [])
                        , (Task.TaskID 20, [])
                        ]
